...
CREATE TABLE BaseAuthConfiguration (
...
alter table BaseAuthConfiguration add constraint FK692AA3ADD36FD973 foreign key (ORGANIZATIONS_FK) references ORGANIZATIONS;
